...
public class CorrelationLog : AuditedAggregateRoot<Guid>, IMultiTenant
{
    ...
    protected CorrelationLog()
    {
    }

    public CorrelationLog(
        Guid id,
    ...
    public void SetHttpContext(string httpMethod, string url, int? httpStatusCode = null)
    {
    ...
    public void SetUserContext(Guid? userId, string? userName)
    {
        UserId = userId;
        UserName = userName;
    }

    public void SetClientContext(string? clientIpAddress, string? userAgent)
    {
